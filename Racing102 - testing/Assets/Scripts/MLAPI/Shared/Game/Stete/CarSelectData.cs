...
namespace Racing102
{
    ...
    /// </summary>
    public class CarSelectData : NetworkBehaviour
    {
        ...
        public struct LobbySeatConfiguration
        {
            ...
            public LobbySeatConfiguration(CarTypeEnum carClass, int artIdx)
            {
                Car = carClass;
        ...
        {
            new LobbySeatConfiguration(CarTypeEnum.BMW, 0),
            new LobbySeatConfiguration(CarTypeEnum.KIA, 1),
