...
namespace Racing102.Client
{
    ...
    /// </summary>
    public class UICarSelectPlayerSeat : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        private CarTypeEnum m_CarClass;
        ...
        private CarSelectData.SeatState m_State;
        ...
        public void Initialize(int seatIndex)
        {
            ...
            m_State = CarSelectData.SeatState.Inactive;
            m_PlayerNumber = -1;
            ConfigureStateGraphics();
        }

        public void SetState(CarSelectData.SeatState state, int playerIndex, string playerName)
        {
            ...
            if (m_State == CarSelectData.SeatState.Inactive)
                m_PlayerNumber = -1;
            ConfigureStateGraphics();
        }
        ...
        private void ConfigureStateGraphics()
        {
            ...
            else // either active or locked-in... these states are visually very similar
            {
                ...
                if (m_State == CarSelectData.SeatState.LockedIn)
                {
