...
{
#if !UNITY_SERVER
    protected NetworkManager102 _room;
    protected NetworkManager102 Room
    {
        get
        {
            if (_room != null) { return _room; }
            return _room = NetworkManager.singleton as NetworkManager102;
        }
    }
    ...
    void Start()
    {
        if (Room.Config.buildType == BuildType.LOCAL_CLIENT || Room.Config.buildType == BuildType.REMOTE_CLIENT)
        {
            ...
            NetworkManager102.OnClientDisconnected += OnDisconnected;
            NetworkManager102.OnClientConnected += OnConnected;
